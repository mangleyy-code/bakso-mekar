...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>Bakso</strong> Mekar Sari</a>
  ...
  <!-- Menu -->
    <div class="container">
      ...
      <form method="POST" action="">
       ...
       <button><a class="btn btn-success btn-sm" name="konfirm" href="login.php">Konfirmasi Pesanan</a></button>
      </form>        
